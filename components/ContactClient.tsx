    ...
    <main className="bg-[#050505] text-white py-16 sm:py-24 relative overflow-hidden min-h-screen">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-16">
          <div className="p-6 rounded-3xl bg-white/[0.02] border border-white/10 hover:border-[#C5E033]/40 transition-all group flex flex-col items-center text-center">
            ...
            <p className="text-xs text-white/50 mb-3">Direct support & inquiries</p>
            <a
              href="mailto:hello@ironlooplabs.com"
              className="text-sm font-mono font-bold text-[#C5E033] hover:underline"
            >
              hello@ironlooplabs.com
            </a>
          </div>
          ...
          <div className="p-6 rounded-3xl bg-white/[0.02] border border-white/10 hover:border-[#C5E033]/40 transition-all group flex flex-col items-center text-center">
            ...
            <p className="text-xs text-white/50 mb-3">Available for your requests</p>
            <a
          ...
          <div className="p-6 rounded-3xl bg-white/[0.02] border border-white/10 hover:border-[#C5E033]/40 transition-all group flex flex-col items-center text-center">
            ...
            <p className="text-xs text-white/50 mb-3">Headquarters</p>
            <span className="text-sm font-mono font-bold text-[#C5E033]">
              California, USA
            </span>
          </div>
        </div>
