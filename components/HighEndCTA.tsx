            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <input required type="text" name="firstName" aria-label="First Name" value={formData.firstName} onChange={handleChange} placeholder="First Name" className="w-full bg-white border border-black/10 rounded-xl px-4 py-3.5 text-[#0b0d10] text-sm focus:border-black/30 focus:ring-1 focus:ring-black/30 focus:outline-none transition-all placeholder:text-black/40" />
                  <input required type="email" name="email" aria-label="Work Email" value={formData.email} onChange={handleChange} placeholder="Work Email" className="w-full bg-white border border-black/10 rounded-xl px-4 py-3.5 text-[#0b0d10] text-sm focus:border-black/30 focus:ring-1 focus:ring-black/30 focus:outline-none transition-all placeholder:text-black/40" />
                  <input required type="tel" name="phone" aria-label="Phone Number" value={formData.phone} onChange={handleChange} placeholder="Phone Number" className="w-full bg-white border border-black/10 rounded-xl px-4 py-3.5 text-[#0b0d10] text-sm focus:border-black/30 focus:ring-1 focus:ring-black/30 focus:outline-none transition-all placeholder:text-black/40" />
                </div>
                {errorMsg && (
