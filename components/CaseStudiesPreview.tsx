  ...
  return (
    <section className="py-24 lg:py-32 bg-[#050505] relative overflow-hidden">
      ...
      <div className="max-w-container-max mx-auto px-6 lg:px-margin-desktop relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-end mb-16 pt-16 relative">
          {CASE_CARDS.map((card, i) => {
            ...
            return (
              ...
              >
                {/* Floating Badge & Pointer Line on Hover / Active */}
                <AnimatePresence>
                  {isActive && (
                    <motion.div
                ...
                {/* Main Card as Link to Case Studies Page */}
                <Link
                  href={card.href}
                ...
                >
                  <motion.div
                    ...
                    className={`w-full bg-[#0f1016]/90 rounded-3xl border p-8 lg:p-10 cursor-pointer transition-all duration-300 shadow-2xl flex flex-col justify-between ${
                      isActive
                        ? "shadow-[0_0_40px_rgba(197,224,51,0.15)] bg-[#12141c]"
                        : "hover:opacity-90"
                    }`}
                  >
                    <div>
                      ...
                      <div className="flex items-center gap-2 mb-6">
                        <span
                          className={`w-2 h-2 rounded-full ${
                            isActive ? "bg-[#C5E033] animate-pulse" : "bg-white/30"
                          }`}
                        />
                      ...
                      <div className="font-mono text-xs text-white/40 mb-6 font-medium">
                        {card.metricSub}
                      </div>
                    ...
                    <div
                      className={`font-mono text-xs font-bold transition-colors inline-flex items-center gap-1 ${
                        isActive ? "text-[#C5E033] underline" : "text-white/40"
                      }`}
                    >
                      {card.linkText}
                    </div>
